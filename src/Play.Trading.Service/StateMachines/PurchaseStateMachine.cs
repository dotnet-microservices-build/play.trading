    ...
    public class PurchaseStateMachine : MassTransitStateMachine<PurchaseState>
    {
        ...
        private void ConfigureInitialState()
        {
            Initially(
                When(PurchaseRequested)
                    .Then(context =>
                    {//capture the content of the event into the state machine instance 
                    ...
                    .Send(context => new GrantItems(context.Instance.UserId, //this is not a published event but a command sent directly to the queue
        ...
        private void ConfigureAccepted()
        {
            During(Accepted,
                ...
                .Send(context => new DebitGil(context.Instance.UserId,
        ...
        private void ConfigureItemsGranted()
        {
            During(ItemsGranted,
                ...
                When(DebitGilFaulted)
                    .Send(context => new SubtractItems(context.Instance.UserId,
                                                    context.Instance.ItemId,
                                                    context.Instance.Quantity,
                                                    context.Instance.CorrelationId)
                    )
